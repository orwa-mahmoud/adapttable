...
head:
  ...
  - tag: script
    ...
    content: '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"AdaptTable","item":"https://orwa-mahmoud.github.io/adapttable/"},{"@type":"ListItem","position":2,"name":"React
      ...
      columns","item":"https://orwa-mahmoud.github.io/adapttable/v2/formulas/"}]}'
  - tag: meta
    attrs:
      property: og:image
      content: https://orwa-mahmoud.github.io/adapttable/og/formulas.png
  - tag: meta
    attrs:
      name: twitter:image
      content: https://orwa-mahmoud.github.io/adapttable/og/formulas.png
...
[saved view](/adapttable/v2/saved-views/) that can be shared, to whoever sent the link.
...
[Saved views](/adapttable/v2/saved-views/) capture the parameter with the rest of the
...
Related: [pivot tables](/adapttable/v2/pivot/) · [row grouping](/adapttable/v2/row-grouping/) ·
