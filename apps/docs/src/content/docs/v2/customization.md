...
head:
  ...
  - tag: script
    ...
    content: '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"AdaptTable","item":"https://orwa-mahmoud.github.io/adapttable/"},{"@type":"ListItem","position":2,"name":"Customize
      AdaptTable — classNames &
      slots","item":"https://orwa-mahmoud.github.io/adapttable/v2/customization/"}]}'
  - tag: meta
    attrs:
      property: og:image
      content: https://orwa-mahmoud.github.io/adapttable/og/customization.png
  - tag: meta
    attrs:
      name: twitter:image
      content: https://orwa-mahmoud.github.io/adapttable/og/customization.png
slug: v2/customization
---
...
[row styling and heights](/adapttable/v2/row-styling/).
...
Opt-in via `onCellEdit` — see [Inline cell editing](/adapttable/v2/cell-editing/). When
...
Opt-in via `groupBy` — see [Row grouping](/adapttable/v2/row-grouping/). When grouping
...
* `scope: "range"` — the highlighted cell rectangle from
  [cell navigation](/adapttable/v2/cell-navigation/). A rectangle names its own columns,
...
the same shape a [server tier](/adapttable/v2/data-tiers/) receives, so an endpoint that
...
See the [Columns guide](/adapttable/v2/columns/) and the
[ColumnDef table](/adapttable/v2/api/#columndef) for the full column surface
