 ...
 */
describe("kit header filter trigger (radix)", () => {
  const trigger = () =>
  ...
  it.each([
    ...
    renderRadix(<TriggerHarness extra={{ name: value as FilterValue }} />);
...
describe("kit multi-select header widget (radix)", () => {
  const openTags = () => {
    renderRadix(<HeaderHarness extra={{ tags: ["a"] }} />);
