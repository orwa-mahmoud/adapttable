...
head:
  ...
  - tag: script
    ...
    content: '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"AdaptTable","item":"https://orwa-mahmoud.github.io/adapttable/"},{"@type":"ListItem","position":2,"name":"Customize
      ...
      prop-getters","item":"https://orwa-mahmoud.github.io/adapttable/v1/customization/"}]}'
  - tag: meta
    attrs:
      property: og:image
...
Opt-in via `onCellEdit` — see [Inline cell editing](/adapttable/v1/cell-editing/). When
...
Opt-in via `groupBy` — see [Row grouping](/adapttable/v1/row-grouping/). When grouping
...
See the [Columns guide](/adapttable/v1/columns/) and the
[ColumnDef table](/adapttable/v1/api/#columndef) for the full column surface
(`sortValue`, `i18n`, `group`, `hideOnMobile`, …).

To draw the markup yourself from the engine, see [headless](/adapttable/v1/headless/). The CSV button and its helpers are on [CSV export](/adapttable/v1/csv-export/).
