...
head:
  ...
  - tag: script
    ...
    content: '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"AdaptTable","item":"https://adapttable.orwamahmoud.com/"},{"@type":"ListItem","position":2,"name":"MUI
      X DataGrid alternative — v8 breaking changes, Pro
      free","item":"https://adapttable.orwamahmoud.com/v1/react/migrate-from-mui-x-datagrid/"}]}'
  - tag: meta
    attrs:
      property: og:image
  ...
  - tag: meta
    attrs:
      name: twitter:image
      content: https://adapttable.orwamahmoud.com/og/migrate-from-mui-x-datagrid.png
slug: v1/react/migrate-from-mui-x-datagrid
---
...
* **URL-synced, shareable state** — see [URL state](/v1/react/url-state/).
...
* **No `sortModel`/`filterModel`/`paginationModel` objects.** Sorting is a
  ...
  [`onQueryChange`](/v1/data-tiers/) instead of three `*Mode="server"` props.
...
* [Virtualization](/v1/react/virtualization/) — window large lists, free.
