...
head:
  ...
  - tag: script
    ...
    content: '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"AdaptTable","item":"https://orwa-mahmoud.github.io/adapttable/"},{"@type":"ListItem","position":2,"name":"Get
      ...
      kit","item":"https://orwa-mahmoud.github.io/adapttable/v1/getting-started/"}]}'
  - tag: meta
    attrs:
      property: og:image
...
<video src="https://orwa-mahmoud.github.io/adapttable/media/core/tour.mp4" poster="https://orwa-mahmoud.github.io/adapttable/media/core/poster.png?v=2" controls playsinline preload="none" style="width:100%;border-radius:8px" />
...
* [Columns](/adapttable/v1/columns/) — headers, custom cells, the Columns menu
  (show/hide, reorder, pin), resizing.
* [Inline cell editing](/adapttable/v1/cell-editing/) — opt-in `onCellEdit`, kit-native
  editors, keyboard flow.
* [Filtering](/adapttable/v1/filtering/) — every filter type, options sources, chips,
  popover vs drawer.
* [Data tiers](/adapttable/v1/data-tiers/) — server data without a query library
...
Full surface: [API reference](/adapttable/v1/api/) ·
[core concepts](/adapttable/v1/concepts/).
