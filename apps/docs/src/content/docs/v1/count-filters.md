...
head:
  ...
  - tag: script
    ...
    content: '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"AdaptTable","item":"https://orwa-mahmoud.github.io/adapttable/"},{"@type":"ListItem","position":2,"name":"React
      ...
      most","item":"https://orwa-mahmoud.github.io/adapttable/v1/count-filters/"}]}'
  - tag: meta
    attrs:
      property: og:image
...
* Passing JSX as `filters` switches off the declarative filter derivations;
  ...
  [filtering](/adapttable/v1/filtering/) for the built-in `numberRange` widget, which
  stores an inclusive `${key}Min`/`${key}Max` pair instead of an operator.

Related: [filtering](/adapttable/v1/filtering/) · [data tiers](/adapttable/v1/data-tiers/) ·
[URL state](/adapttable/v1/url-state/) · [headless](/adapttable/v1/headless/) ·
