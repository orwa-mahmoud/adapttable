...
head:
  ...
  - tag: script
    ...
    content: '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"AdaptTable","item":"https://orwa-mahmoud.github.io/adapttable/"},{"@type":"ListItem","position":2,"name":"Accessible
      React data table — keyboard, screen
      readers","item":"https://orwa-mahmoud.github.io/adapttable/v2/accessibility/"}]}'
  - tag: meta
    attrs:
      property: og:image
      content: https://orwa-mahmoud.github.io/adapttable/og/accessibility.png
  - tag: meta
    attrs:
      name: twitter:image
      content: https://orwa-mahmoud.github.io/adapttable/og/accessibility.png
slug: v2/accessibility
---

▶ **See it working:** [arrow through a Mantine table and read the live-region transcript](https://orwa-mahmoud.github.io/adapttable/demo/mantine/accessibility/) — Tab in, arrow between cells, and every announcement appears as text. The same page exists for MUI, Chakra, antd, Radix, Base UI, shadcn and Tailwind. Keyboard walk is documented in [cell navigation](/adapttable/v2/cell-navigation/).
...
**Related:** [Keyboard & cell navigation](/adapttable/v2/cell-navigation/) ·
[i18n & RTL](/adapttable/v2/i18n-rtl/) · [FAQ](/adapttable/v2/faq/)
...
[keyboard & cell navigation](/adapttable/v2/cell-navigation/). Omit that prop and the
...
* Labels you pass through `labels` are the accessible names, including in
  Arabic and the other [bundled locales](/adapttable/v2/i18n-rtl/).
