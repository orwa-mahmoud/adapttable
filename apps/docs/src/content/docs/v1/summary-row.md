...
head:
  ...
  - tag: script
    ...
    content: '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"AdaptTable","item":"https://orwa-mahmoud.github.io/adapttable/"},{"@type":"ListItem","position":2,"name":"React
      ...
      totals","item":"https://orwa-mahmoud.github.io/adapttable/v1/summary-row/"}]}'
  - tag: meta
    attrs:
      property: og:image
...
* **Which rows it receives** — the rows the body renders: the current page
  or loaded slice (`source.rows`). With [row grouping](/adapttable/v1/row-grouping/)
  ...
  [virtualization](/adapttable/v1/virtualization/) on, it still receives the whole
...
* The summary row is not part of a [CSV export](/adapttable/v1/csv-export/); the file
...
* [Row grouping](/adapttable/v1/row-grouping/) — `groupAggregates`, the per-group counterpart
* [Columns](/adapttable/v1/columns/) — `align`, `mobileLabel`, `hideOnMobile`
* [Customization](/adapttable/v1/customization/) — the `summary`, `summaryRow`, `summaryCell` and `summaryCard` slots
* [Pagination](/adapttable/v1/pagination/) — what "the current page" means per mode
* [API reference](/adapttable/v1/api/)
