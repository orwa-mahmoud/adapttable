/**
 * The host callbacks on the owning features, fired by a real antd table: the
 * edit history handle, the unsaved-edit count and the selected cell range.
 */
