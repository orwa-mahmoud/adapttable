...
head:
  ...
  - tag: script
    ...
    content: '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"AdaptTable","item":"https://adapttable.orwamahmoud.com/"},{"@type":"ListItem","position":2,"name":"React
      ...
      nodes","item":"https://adapttable.orwamahmoud.com/v1/react/virtualization/"}]}'
  - tag: meta
    attrs:
      property: og:image
...
▶ **See it working:** [scroll 50,000 rows in the live demo](https://adapttable.orwamahmoud.com/react/demo/scale/) — a real table you can scroll, not a recording.
