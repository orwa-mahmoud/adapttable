...
head:
  ...
  - tag: script
    ...
    content: '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"AdaptTable","item":"https://adapttable.orwamahmoud.com/"},{"@type":"ListItem","position":2,"name":"Migrate
      ...
      built-in","item":"https://adapttable.orwamahmoud.com/v2/react/migrate-from-mantine-datatable/"}]}'
  - tag: meta
    attrs:
      property: og:image
  ...
  - tag: meta
    attrs:
      name: twitter:image
      content: https://adapttable.orwamahmoud.com/og/migrate-from-mantine-datatable.png
slug: v2/react/migrate-from-mantine-datatable
---
...
* **URL-synced, shareable, reload-safe state** — mantine-datatable keeps state
  in React only. See [URL state](/v2/react/url-state/).
...
* **Saved views, an automatic mobile card layout, and opt-in
  ...
  [saved views](/v2/react/saved-views/) and [virtualization](/v2/react/virtualization/).
...
* **Stop sorting and slicing `records`.** On the frontend tier, hand the full
  ...
  table does it. For a server API, use the [server tier](/v2/data-tiers/)
...
* [Getting started](/v2/react/getting-started/) — install, providers, first table.
* [Filtering](/v2/react/filtering/) · [Data tiers](/v2/data-tiers/) ·
  [Column management](/v2/react/column-management/) · [Saved views](/v2/react/saved-views/).
