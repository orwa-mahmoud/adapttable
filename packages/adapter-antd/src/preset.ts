/**
 * The standard preset — `@adapttable/antd/preset`.
 *
 * One import for the table most people want: every feature that is useful
 * with no configuration at all, drawn with antd's own components. It is
 ...
 *
 * ```tsx
 * import { standardFeatures } from "@adapttable/antd/preset";
 *
