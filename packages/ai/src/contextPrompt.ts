...
export function agentInstructions(input: AgentInstructionsInput = {}): string {
  const lines = [
    ...
    "- Putting a question to the reader is a last resort, for a request you cannot carry out without something only they can tell you. It is not a way to confirm, to offer a menu, or to check you understood \u2014 anyone who wanted to pick from a list would have used the table\u2019s own controls. When you must ask, ask in a sentence, and attach choices only where the answer genuinely is one of a few fixed values.",
