...
head:
  ...
  - tag: script
    ...
    content: '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"AdaptTable","item":"https://orwa-mahmoud.github.io/adapttable/"},{"@type":"ListItem","position":2,"name":"Migrate
      ...
      (MIT)","item":"https://orwa-mahmoud.github.io/adapttable/v2/migrate-from-mui-x-datagrid/"}]}'
  - tag: meta
    attrs:
      property: og:image
  ...
  - tag: meta
    attrs:
      name: twitter:image
      content: https://orwa-mahmoud.github.io/adapttable/og/migrate-from-mui-x-datagrid.png
slug: v2/migrate-from-mui-x-datagrid
---
...
* **URL-synced, shareable state** — see [URL state](/adapttable/v2/url-state/).
...
* **No `sortModel`/`filterModel`/`paginationModel` objects.** Sorting is a
  ...
  [`onQueryChange`](/adapttable/v2/data-tiers/) instead of three `*Mode="server"` props.
...
* [Virtualization](/adapttable/v2/virtualization/) — window large lists, free.
