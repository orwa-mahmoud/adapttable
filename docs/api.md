...
| `error`         | `Error \| null`                             | `null`         | antd, mantine, mui, shadcn, unstyled | Forwarded error to display in the table's error state (retry via the source's `refetch`).                                                                                                                 |
...
| `supports`      | `QuerySupport`                              | —              | antd                                 | Server tier: capabilities this endpoint answers. `supports.facets` unlocks `query.facets`.                                                                                                                |
| `facetKeys`     | `readonly string[]`                         | checklist keys | antd                                 | Server tier: keys sent as `query.facets`. Defaults to every `checklist` definition.                                                                                                                       |
| `facets`        | `FacetMap`                                  | —              | antd                                 | Server tier: distinct-value counts from the last fetch, surfaced on the source for the checklist.                                                                                                         |
