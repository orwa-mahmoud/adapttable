...
head:
  ...
  - tag: script
    ...
    content: '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"AdaptTable","item":"https://orwa-mahmoud.github.io/adapttable/"},{"@type":"ListItem","position":2,"name":"material-table
      alternative — modern MUI, still
      MIT","item":"https://orwa-mahmoud.github.io/adapttable/v1/migrate-from-material-table/"}]}'
  - tag: meta
    attrs:
      property: og:image
  ...
  - tag: meta
    attrs:
      name: twitter:image
      content: https://orwa-mahmoud.github.io/adapttable/og/migrate-from-material-table.png
slug: v1/migrate-from-material-table
---
...
* **Full row-edit CRUD suites** (`editable` as a material-table-style
  ...
  [Inline cell editing](/adapttable/v1/cell-editing/)), not material-table's row
...
| `localization`                                       | `labels` (+ [`@adapttable/i18n`](/adapttable/v1/i18n-rtl/))      | Flat label object; presets for 17 locales incl. RTL.                 |
| `isLoading`                                          | `loading`                                             | —                                                                    |
...
* [Getting started](/adapttable/v1/getting-started/) · [Data tiers](/adapttable/v1/data-tiers/) ·
  [Filtering](/adapttable/v1/filtering/) · [Selection & bulk actions](/adapttable/v1/selection/).
* Same app also uses DataGrid or mui-datatables? See
  [Migrate from MUI X DataGrid](/adapttable/v1/migrate-from-mui-x-datagrid/) and
  [Migrate from mui-datatables](/adapttable/v1/migrate-from-mui-datatables/).
* [Comparison](/adapttable/v1/comparison/) — where each library fits.
