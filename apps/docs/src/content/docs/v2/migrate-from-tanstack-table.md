...
head:
  ...
  - tag: script
    ...
    content: '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"AdaptTable","item":"https://orwa-mahmoud.github.io/adapttable/"},{"@type":"ListItem","position":2,"name":"Migrate
      ...
      kits","item":"https://orwa-mahmoud.github.io/adapttable/v2/migrate-from-tanstack-table/"}]}'
  - tag: meta
    attrs:
      property: og:image
  ...
  - tag: meta
    attrs:
      name: twitter:image
      content: https://orwa-mahmoud.github.io/adapttable/og/migrate-from-tanstack-table.png
slug: v2/migrate-from-tanstack-table
---
...
* **A filter UI.** TanStack gives you `columnFilters` state and
  ...
  declaration. See [filtering](/adapttable/v2/filtering/).
...
* **Saved views** — no concept in TanStack. See [saved views](/adapttable/v2/saved-views/).
...
| `getSubRows` (sub-row hierarchy)                                      | `getChildren` (or `getParentId`)                                        | Tree data with its own chevron and indent. See [tree data](/adapttable/v2/tree-data/).                    |
...
| `manualSorting` / `manualFiltering` / `manualPagination`              | `onQueryChange` (or `source` via `useQuerySource`)                      | One consolidated server query. See [data tiers](/adapttable/v2/data-tiers/).                              |
...
* [Concepts](/adapttable/v2/concepts/) — the headless engine and `TableSource`.
* [Getting started](/adapttable/v2/getting-started/) · [Filtering](/adapttable/v2/filtering/) ·
  [Data tiers](/adapttable/v2/data-tiers/) · [API reference](/adapttable/v2/api/).
