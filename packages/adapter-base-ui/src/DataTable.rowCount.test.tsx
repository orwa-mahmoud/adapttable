 ...
 * Core decides; this proves the base-ui table element carries it — the kit's own Table.Root spreads props onto its scroll wrapper.
 */
...
describe("windowed table — dataset size (base-ui)", () => {
