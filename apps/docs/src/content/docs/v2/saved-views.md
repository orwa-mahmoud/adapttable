...
head:
  ...
  - tag: script
    ...
    content: '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"AdaptTable","item":"https://orwa-mahmoud.github.io/adapttable/"},{"@type":"ListItem","position":2,"name":"React
      ...
      URL","item":"https://orwa-mahmoud.github.io/adapttable/v2/saved-views/"}]}'
  - tag: meta
    attrs:
      property: og:image
...
the [pivot configuration](/adapttable/v2/pivot/) and typed
[formula columns](/adapttable/v2/formulas/). The parts that take longest to
