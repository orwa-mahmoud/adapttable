/**
 * The standard preset — `@adapttable/shadcn/preset`.
 *
 * One import for the table most people want: every feature that is useful
 * with no configuration at all, drawn with shadcn/ui's own components. It is
 ...
 *
 * ```tsx
 * import { standardFeatures } from "@adapttable/shadcn/preset";
 *
