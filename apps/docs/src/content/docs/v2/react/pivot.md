...
head:
  ...
  - tag: script
    ...
    content: '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"AdaptTable","item":"https://adapttable.orwamahmoud.com/"},{"@type":"ListItem","position":2,"name":"React
      ...
      measures","item":"https://adapttable.orwamahmoud.com/v2/react/pivot/"}]}'
  - tag: meta
    attrs:
      property: og:image
      content: https://adapttable.orwamahmoud.com/og/pivot.png
  - tag: meta
    attrs:
      name: twitter:image
      content: https://adapttable.orwamahmoud.com/og/pivot.png
...
Drop it into a [side panel](/v2/react/customization/) as that panel's content, and
...
All four are also on [`@adapttable/core/query`](/v2/server-queries/#decoding-a-parameter-yourself),
...
Related: [row grouping](/v2/react/row-grouping/) ·
[aggregation](/v2/react/row-grouping/#aggregate-without-writing-the-maths) · [API reference](/v2/react/api/)
