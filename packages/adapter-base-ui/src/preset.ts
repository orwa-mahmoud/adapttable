/**
 * The standard preset — `@adapttable/base-ui/preset`.
 *
 * One import for the table most people want: every feature that is useful
 * with no configuration at all, drawn with Base UI's own components. It is
 ...
 *
 * ```tsx
 * import { standardFeatures } from "@adapttable/base-ui/preset";
 *
