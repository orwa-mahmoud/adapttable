...
| `addAggregation` / `removeAggregation` / `restoreAggregationDefaults` / `reconcileAggregations` / `initialOperation` / `declaredByDeveloper` / `AGGREGATE_SUPPRESSED`                                                                                                                                                    | Reader transitions and URL/saved-view cleanup. Removing a developer default writes `AGGREGATE_SUPPRESSED` (`"none"`).                                                                                                                                                                                                                                                                                                                                                                                |
...
| `CUSTOM_AGGREGATE` / `DeclaredAggregates` / `declaredAggregates` / `GroupAggregatesMapper`                                                                                                                                                                                                                               | Metadata on `aggregate()`: a declared mapper's operation ids, or `CUSTOM_AGGREGATE` when the host supplied a function.                                                                                                                                                                                                                                                                                                                                                                               |
