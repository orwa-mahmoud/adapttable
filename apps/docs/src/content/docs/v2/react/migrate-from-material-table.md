...
head:
  ...
  - tag: script
    ...
    content: '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"AdaptTable","item":"https://adapttable.orwamahmoud.com/"},{"@type":"ListItem","position":2,"name":"Migrate
      from material-table —
      maintained","item":"https://adapttable.orwamahmoud.com/v2/react/migrate-from-material-table/"}]}'
  - tag: meta
    attrs:
      property: og:image
  ...
  - tag: meta
    attrs:
      name: twitter:image
      content: https://adapttable.orwamahmoud.com/og/migrate-from-material-table.png
slug: v2/react/migrate-from-material-table
---
...
* **Full row-edit CRUD suites** (`editable` as a material-table-style
  ...
  [Inline cell editing](/v2/react/cell-editing/)) — plus `onAddRow` (a toolbar Add
...
* **Drag-to-group aggregation** (`options.grouping`) — AdaptTable ships
  [row grouping](/v2/react/row-grouping/) at any depth (`groupBy` takes one key or an
  ...
  that gesture.
* **Tree data** (`parentChildData`) — [`getParentId`](/v2/react/tree-data/) is the
...
* **PDF export button** — the export button takes a writer, so
  ...
  [PDF export](/v2/react/export-pdf/).
...
| `localization`                                       | `labels` (+ [`@adapttable/i18n`](/v2/react/i18n-rtl/))      | Flat label object; presets for 17 locales incl. RTL.                                    |
| `isLoading`                                          | `loading`                                             | —                                                                                       |
...
* [Getting started](/v2/react/getting-started/) · [Data tiers](/v2/data-tiers/) ·
  [Filtering](/v2/react/filtering/) · [Selection & bulk actions](/v2/react/selection/).
* Same app also uses DataGrid or mui-datatables? See
  [Migrate from MUI X DataGrid](/v2/react/migrate-from-mui-x-datagrid/) and
  [Migrate from mui-datatables](/v2/react/migrate-from-mui-datatables/).
