...
head:
  ...
  - tag: script
    ...
    content: '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"AdaptTable","item":"https://orwa-mahmoud.github.io/adapttable/"},{"@type":"ListItem","position":2,"name":"React
      ...
      dialogs","item":"https://orwa-mahmoud.github.io/adapttable/v1/row-actions/"}]}'
  - tag: meta
    attrs:
      property: og:image
...
* **Row clicks.** Desktop action clicks stop propagation, and `onRowClick`
  ...
  activates the row. See [row & display options](/adapttable/v1/row-and-display-options/).
* **Column management.** The actions column uses the reserved layout key
  ...
  ("Actions"). See [column management](/adapttable/v1/column-management/).
...
covered in [selection](/adapttable/v1/selection/).
