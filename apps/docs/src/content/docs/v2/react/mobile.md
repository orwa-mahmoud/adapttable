...
head:
  ...
  - tag: script
    ...
    content: '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"AdaptTable","item":"https://adapttable.orwamahmoud.com/"},{"@type":"ListItem","position":2,"name":"Responsive
      React table — mobile card
      layout","item":"https://adapttable.orwamahmoud.com/v2/react/mobile/"}]}'
  - tag: meta
    attrs:
      property: og:image
      content: https://adapttable.orwamahmoud.com/og/mobile.png
  - tag: meta
    attrs:
      name: twitter:image
      content: https://adapttable.orwamahmoud.com/og/mobile.png
slug: v2/react/mobile
---
...
<a href="https://adapttable.orwamahmoud.com/react/demo/mantine/mobile-cards/">
  <img src="https://adapttable.orwamahmoud.com/media/features/mobile.gif" alt="The same AdaptTable data table as phone cards — scrolling the card list, then switching to the desktop table" width="640" height="392" style="width:100%;height:auto;aspect-ratio:640/392;border-radius:8px" />
</a>
...
* **`rowClassName`** applies to desktop rows and mobile cards alike, and the
  [class-hook / `data-adapttable-part` surface](/v2/react/customization/) names the
...
* **Grouping** renders group header blocks between cards, with the same
  collapse behavior as desktop — see [row grouping](/v2/react/row-grouping/).
* **Virtualization** windows the card list the same way it windows rows:
  ...
  see [virtualization](/v2/react/virtualization/).
...
* **Every adapter ships it**: Mantine, MUI, Chakra, Ant Design, Radix,
  ...
  the [comparison table](/v2/react/comparison/) tracks it as a built-in across
  the board.
...
Related: [Getting started](/v2/react/getting-started/) ·
