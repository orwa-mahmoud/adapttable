 ...
 * from Ant Design, and that the structure the chrome owns arrives intact.
 */
...
describe("TableAssistant", () => {
  ...
  it("draws its controls with Ant Design's own components", () => {
    mount(
      <TableAssistant
        assistant={view()}
        labels={defaultLabels}
    ...
    expect(part("assistant-send")!.className).toContain("ant-btn");
  });
});
