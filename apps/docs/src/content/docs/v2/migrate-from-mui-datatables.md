...
head:
  ...
  - tag: script
    ...
    content: '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"AdaptTable","item":"https://orwa-mahmoud.github.io/adapttable/"},{"@type":"ListItem","position":2,"name":"Migrate
      ...
      v6+","item":"https://orwa-mahmoud.github.io/adapttable/v2/migrate-from-mui-datatables/"}]}'
  - tag: meta
    attrs:
      property: og:image
      content: https://orwa-mahmoud.github.io/adapttable/og/migrate-from-mui-datatables.png
  - tag: meta
    attrs:
      name: twitter:image
      content: https://orwa-mahmoud.github.io/adapttable/og/migrate-from-mui-datatables.png
slug: v2/migrate-from-mui-datatables
---
...
overview](/adapttable/v2/getting-started/).
...
* **`textLabels` → `labels`**, and locale presets (incl. RTL languages) come
  from [`@adapttable/i18n`](/adapttable/v2/i18n-rtl/).
...
* Also migrating the grid elsewhere in your app? See
  [Migrate from MUI X DataGrid](/adapttable/v2/migrate-from-mui-x-datagrid/).
