...
[![@adapttable/mui — a Material UI data table built on AdaptTable](https://adapttable.orwamahmoud.com/media/adapters/mui/parts/filtering.gif)](https://adapttable.orwamahmoud.com/react/demo/?kit=mui)

**[📖 Documentation](https://adapttable.orwamahmoud.com/)** · **[🚀 Live demo](https://adapttable.orwamahmoud.com/react/demo/)** · **[Get started](https://adapttable.orwamahmoud.com/react/getting-started/)** · **[⚡ Try in StackBlitz](https://stackblitz.com/github/orwa-mahmoud/adapttable/tree/main/starters/mui)**

_Migrating from MUI X DataGrid? See the [migration guide](https://adapttable.orwamahmoud.com/react/migrate-from-mui-x-datagrid/)._
...
- **Selection + bulk actions** using MUI `Checkbox`es, composed with `bulkActions(...)`.
...
- **Feature composition** (`features={[rowReorder(fn)]}`) from `@adapttable/mui/row-reorder`-style subpaths — the import is the switch, and `standardFeatures()` on the `/preset` entry is the one-import path. Host plugins share the same `setup(host)` surface.
...
- **Customisation** — `slots` (skeleton, empty), `className`, `size`, injectable `confirm`, and the full headless escape hatch via `@adapttable/react`.
...
![mui Row grouping](https://adapttable.orwamahmoud.com/media/adapters/mui/parts/row-grouping.gif)

**Inline cell editing** — double-click a cell; text, number and select editors

![mui Inline cell editing](https://adapttable.orwamahmoud.com/media/adapters/mui/parts/cell-editing.gif)

**Filtering** — type a bound and the table answers as you type

![mui Filtering](https://adapttable.orwamahmoud.com/media/adapters/mui/parts/filtering.gif)

**Column management** — show, hide, reorder, pin and resize

![mui Column management](https://adapttable.orwamahmoud.com/media/adapters/mui/parts/column-management.gif)

**RTL / Arabic** — the whole table mirrors, not just the text

![mui RTL / Arabic](https://adapttable.orwamahmoud.com/media/adapters/mui/parts/rtl.gif)
