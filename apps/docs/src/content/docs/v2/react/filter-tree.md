...
head:
  ...
  - tag: script
    ...
    content: '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"AdaptTable","item":"https://adapttable.orwamahmoud.com/"},{"@type":"ListItem","position":2,"name":"React
      ...
      groups","item":"https://adapttable.orwamahmoud.com/v2/react/filter-tree/"}]}'
  - tag: meta
    attrs:
      property: og:image
      content: https://adapttable.orwamahmoud.com/og/filter-tree.png
  - tag: meta
    attrs:
      name: twitter:image
      content: https://adapttable.orwamahmoud.com/og/filter-tree.png
slug: v2/react/filter-tree
---
...
[Other UI kits →](/v2/react/getting-started/#try-it-in-stackblitz)
...
The field widgets, operators and chips are on [filtering](/v2/react/filtering/).
The URL codec is on [url-state](/v2/react/url-state/).
