---
title: "React table saved views — shareable named layouts (v1)"
...
head:
  ...
  - tag: script
    ...
    content: '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"AdaptTable","item":"https://orwa-mahmoud.github.io/adapttable/"},{"@type":"ListItem","position":2,"name":"React
      table saved views — shareable named
      layouts","item":"https://orwa-mahmoud.github.io/adapttable/v1/saved-views/"}]}'
  - tag: meta
    attrs:
      property: og:image
      content: https://orwa-mahmoud.github.io/adapttable/og/saved-views.png
  - tag: meta
    attrs:
      name: twitter:image
      content: https://orwa-mahmoud.github.io/adapttable/og/saved-views.png
...
* A view stores the table-scoped query string — search, sort, page and
  page-size, `groupBy`, every `f_*` filter param, and the URL-persisted column
  layout. The multi-sort chain (`sort=`) is not captured, and applying a view
  leaves it in place.
