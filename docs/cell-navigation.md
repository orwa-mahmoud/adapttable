...
name ("Select column: Team", translated in all eighteen locales).
...
`labels.gridRangeSelection`, translated in all eighteen locales. A single cell
...
translated in all eighteen locales.
