...
head:
  ...
  - tag: script
    ...
    content: '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"AdaptTable","item":"https://adapttable.orwamahmoud.com/"},{"@type":"ListItem","position":2,"name":"React
      ...
      Next.js","item":"https://adapttable.orwamahmoud.com/v2/react/ssr-rsc/"}]}'
  - tag: meta
    attrs:
      property: og:image
      content: https://adapttable.orwamahmoud.com/og/ssr-rsc.png
  - tag: meta
    attrs:
      name: twitter:image
      content: https://adapttable.orwamahmoud.com/og/ssr-rsc.png
slug: v2/react/ssr-rsc
---
...
[Getting started](/v2/react/getting-started/)
...
* Server components can fetch, sort and filter before the table ever sees the
  ...
  [server tier](/v2/data-tiers/) and let it drive your endpoint.
