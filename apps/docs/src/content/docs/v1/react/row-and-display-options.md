...
head:
  ...
  - tag: script
    ...
    content: '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"AdaptTable","item":"https://adapttable.orwamahmoud.com/"},{"@type":"ListItem","position":2,"name":"React
      ...
      header","item":"https://adapttable.orwamahmoud.com/v1/react/row-and-display-options/"}]}'
  - tag: meta
    attrs:
      property: og:image
  ...
  - tag: meta
    attrs:
      name: twitter:image
      content: https://adapttable.orwamahmoud.com/og.png
slug: v1/react/row-and-display-options
---
...
* `maxHeight` (a fixed-height scroll box) is covered in
  [customization](/v1/react/customization/#sticky-header-offset--scroll-box).
* Per-row buttons are on [row actions](/v1/react/row-actions/); column-level display
  options are on [columns](/v1/react/columns/).
