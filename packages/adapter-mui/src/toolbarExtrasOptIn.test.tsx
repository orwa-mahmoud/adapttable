/**
 * "Omitting a prop renders nothing" — proved for MUI's toolbar extras.
 *
...
describe("MUI toolbar extras are opt-in", () => {
  it("draws no undo/redo without BOTH handlers", () => {
    const only = renderMui(
    ...
    const neither = renderMui(<UndoRedoButtons {...base} />);
