...
head:
  ...
  - tag: script
    ...
    content: '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"AdaptTable","item":"https://orwa-mahmoud.github.io/adapttable/"},{"@type":"ListItem","position":2,"name":"React
      ...
      actions","item":"https://orwa-mahmoud.github.io/adapttable/v1/selection/"}]}'
  - tag: meta
    attrs:
      property: og:image
...
Per-row actions and their confirmation dialogs are on [row actions](/adapttable/v1/row-actions/).
