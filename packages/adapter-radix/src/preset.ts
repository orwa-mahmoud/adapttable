/**
 * The standard preset — `@adapttable/radix/preset`.
 *
 * One import for the table most people want: every feature that is useful
 * with no configuration at all, drawn with Radix Themes's own components. It is
 ...
 *
 * ```tsx
 * import { standardFeatures } from "@adapttable/radix/preset";
 *
