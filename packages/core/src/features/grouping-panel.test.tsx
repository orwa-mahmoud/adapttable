  ...
  return (
    <div>
      ...
      <button
        ...
        {...panel.chipDragProps("team")}
        {...panel.chipKeyboardProps("team", "Team")}
      >
        {"Team chip"}
      </button>
      <div data-testid="drop-1" {...panel.dropProps(1)} />
      <div data-testid="remove-zone" {...panel.removeDropProps()} />
    </div>
  );
}
