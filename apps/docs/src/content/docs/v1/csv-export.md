...
head:
  ...
  - tag: script
    ...
    content: '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"AdaptTable","item":"https://orwa-mahmoud.github.io/adapttable/"},{"@type":"ListItem","position":2,"name":"React
      ...
      button","item":"https://orwa-mahmoud.github.io/adapttable/v1/csv-export/"}]}'
  - tag: meta
    attrs:
      property: og:image
...
* The CSV contains data rows only — group header rows and the
  [summary row](/adapttable/v1/summary-row/) are not written.

## Related

* [Columns](/adapttable/v1/columns/) — `header`, `accessor`, `sortValue`, visibility
* [Column management](/adapttable/v1/column-management/) — the user layout the export follows
* [Data tiers](/adapttable/v1/data-tiers/) — which sources provide the full filtered set
* [Customization](/adapttable/v1/customization/) — the `exportCsvButton` class slot
* [i18n & RTL](/adapttable/v1/i18n-rtl/) — translating the button label
