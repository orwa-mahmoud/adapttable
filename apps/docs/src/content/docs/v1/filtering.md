...
head:
  ...
  - tag: script
    ...
    content: '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"AdaptTable","item":"https://orwa-mahmoud.github.io/adapttable/"},{"@type":"ListItem","position":2,"name":"React
      ...
      state","item":"https://orwa-mahmoud.github.io/adapttable/v1/filtering/"}]}'
  - tag: meta
    attrs:
      property: og:image
...
Filtering by how many related items a row has is on [count filters](/adapttable/v1/count-filters/).
