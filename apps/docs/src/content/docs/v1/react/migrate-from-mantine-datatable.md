...
head:
  ...
  - tag: script
    ...
    content: '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"AdaptTable","item":"https://adapttable.orwamahmoud.com/"},{"@type":"ListItem","position":2,"name":"mantine-datatable
      alternative — same Mantine, more
      built-in","item":"https://adapttable.orwamahmoud.com/v1/react/migrate-from-mantine-datatable/"}]}'
  - tag: meta
    attrs:
      property: og:image
      content: https://adapttable.orwamahmoud.com/og/migrate-from-mantine-datatable.png
  - tag: meta
    attrs:
      name: twitter:image
      content: https://adapttable.orwamahmoud.com/og/migrate-from-mantine-datatable.png
slug: v1/react/migrate-from-mantine-datatable
---
...
* **URL-synced, shareable, reload-safe state** — mantine-datatable keeps state
  in React only. See [URL state](/v1/react/url-state/).
* **A ready Columns menu** (show/hide, reorder, pin) via `enableColumnMenu`, and
  ...
  [column management](/v1/react/column-management/).
* **Saved views, an automatic mobile card layout, and opt-in
  virtualization** — none of which mantine-datatable ships. See
  [saved views](/v1/react/saved-views/) and [virtualization](/v1/react/virtualization/).
...
* **Stop sorting and slicing `records`.** On the frontend tier, hand the full
  ...
  table does it. For a server API, use the [server tier](/v1/data-tiers/)
...
* [Getting started](/v1/react/getting-started/) — install, providers, first table.
* [Filtering](/v1/react/filtering/) · [Data tiers](/v1/data-tiers/) ·
  [Column management](/v1/react/column-management/) · [Saved views](/v1/react/saved-views/).
