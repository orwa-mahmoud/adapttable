...
head:
  ...
  - tag: script
    ...
    content: '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"AdaptTable","item":"https://orwa-mahmoud.github.io/adapttable/"},{"@type":"ListItem","position":2,"name":"React
      ...
      nodes","item":"https://orwa-mahmoud.github.io/adapttable/v2/virtualization/"}]}'
  - tag: meta
    attrs:
      property: og:image
...
* `rowHeight` overrides the estimate when set — a function is per row, so
  a variable-height table still windows. See [row styling and heights](/adapttable/v2/row-styling/).
...
* The same switch is a feature: `features={[virtualize()]}` from
  ...
  [feature composition](/adapttable/v2/features/).
