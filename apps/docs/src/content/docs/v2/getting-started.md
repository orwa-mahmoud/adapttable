...
head:
  ...
  - tag: script
    ...
    content: '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"AdaptTable","item":"https://orwa-mahmoud.github.io/adapttable/"},{"@type":"ListItem","position":2,"name":"Get
      started — a React table for your UI
      kit","item":"https://orwa-mahmoud.github.io/adapttable/v2/getting-started/"}]}'
  - tag: meta
    attrs:
      property: og:image
      content: https://orwa-mahmoud.github.io/adapttable/og/getting-started.png
  - tag: meta
    attrs:
      name: twitter:image
      content: https://orwa-mahmoud.github.io/adapttable/og/getting-started.png
...
<video src="https://orwa-mahmoud.github.io/adapttable/media/core/tour.mp4" poster="https://orwa-mahmoud.github.io/adapttable/media/core/poster.png?v=2" controls playsinline preload="none" width="1500" height="1065" style="width:100%;height:auto;aspect-ratio:1500/1065;border-radius:8px" />
...
* [Columns](/adapttable/v2/columns/) — headers, custom cells, the Columns menu
  (show/hide, reorder, pin), resizing.
* [Inline cell editing](/adapttable/v2/cell-editing/) — opt-in `onCellEdit`, kit-native
  editors, keyboard flow.
* [Row reordering](/adapttable/v2/row-reordering/) — opt-in `onRowReorder`, Space-lift
  keyboard, dataset-relative indices.
* [Row pinning](/adapttable/v2/row-pinning/) — sticky top and bottom rows, `{ top, bottom }` ids
* [Row and column spanning](/adapttable/v2/row-spanning/) — `getCellSpan`, one cell list per row
* [Full-width and separator rows](/adapttable/v2/full-width-rows/) — `extraRows`, host-injected slots
* [Row styling and heights](/adapttable/v2/row-styling/) — `rowStyle`, `rowHeight`, variable-height virtualizer
* [Filtering](/adapttable/v2/filtering/) — every filter type, options sources, chips,
  popover vs drawer.
* [Data tiers](/adapttable/v2/data-tiers/) — server data without a query library
...
Full surface: [API reference](/adapttable/v2/api/) ·
[core concepts](/adapttable/v2/concepts/).
