---
title: "React table i18n & RTL — Arabic, Hebrew (v2)"
...
head:
  ...
  - tag: script
    ...
    content: '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"AdaptTable","item":"https://adapttable.orwamahmoud.com/"},{"@type":"ListItem","position":2,"name":"React
      table i18n & RTL — Arabic,
      Hebrew","item":"https://adapttable.orwamahmoud.com/v2/react/i18n-rtl/"}]}'
  - tag: meta
    attrs:
      property: og:image
...
* `locales` — every preset, keyed by tag (`LocaleKey` is its key union)
