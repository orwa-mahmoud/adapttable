...
head:
  ...
  - tag: script
    ...
    content: '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"AdaptTable","item":"https://orwa-mahmoud.github.io/adapttable/"},{"@type":"ListItem","position":2,"name":"React
      ...
      collapsible","item":"https://orwa-mahmoud.github.io/adapttable/v2/column-groups/"}]}'
  - tag: meta
    attrs:
      property: og:image
      content: https://orwa-mahmoud.github.io/adapttable/og/column-groups.png
  - tag: meta
    attrs:
      name: twitter:image
      content: https://orwa-mahmoud.github.io/adapttable/og/column-groups.png
slug: v2/column-groups
---
...
This is not [row grouping](/adapttable/v2/row-grouping/). Rows fold under a `groupBy`;
columns span under a parent header.

**Related:** [Columns](/adapttable/v2/columns/) · [Column management](/adapttable/v2/column-management/)
