---
title: "MUI X DataGrid alternative — v8 breaking changes, Pro free (v1)"
...
head:
  ...
  - tag: script
    ...
    content: '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"AdaptTable","item":"https://orwa-mahmoud.github.io/adapttable/"},{"@type":"ListItem","position":2,"name":"MUI
      X DataGrid alternative — v8 breaking changes, Pro
      free","item":"https://orwa-mahmoud.github.io/adapttable/v1/migrate-from-mui-x-datagrid/"}]}'
  - tag: meta
    attrs:
      property: og:image
      content: https://orwa-mahmoud.github.io/adapttable/og/migrate-from-mui-x-datagrid.png
  - tag: meta
    attrs:
      name: twitter:image
      content: https://orwa-mahmoud.github.io/adapttable/og/migrate-from-mui-x-datagrid.png
slug: v1/migrate-from-mui-x-datagrid
---
...
* **URL-synced, shareable state** — see [URL state](/adapttable/v1/url-state/).
...
* **No `sortModel`/`filterModel`/`paginationModel` objects.** Sorting is a
  ...
  [`onQueryChange`](/adapttable/v1/data-tiers/) instead of three `*Mode="server"` props.
...
* [Virtualization](/adapttable/v1/virtualization/) — window large lists, free.
