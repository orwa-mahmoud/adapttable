...
| `AggregationModel` / `AggregationModelInput` / `AggregationItem` / `AggregationCandidate` / `AggregationOrigin` / `aggregationModel`                                                                                                                                                                                     | The list the panel and column menu both draw: active items, addable candidates, and whether the reader is still at the developer's defaults.                                                                                                                                                                                                                                                                                                                                                         |
| `resolveEffectiveAggregation` / `EffectiveAggregation` / `effectiveAggregateOps` / `readerControlAllowed` / `columnAggregationSignature`                                                                                                                                                                                 | Shared precedence for display and execution: a valid reader override or permitted suppression, then a valid executable column default, then the original host mapper or request. `effectiveAggregateOps` is the map the calculator and the first server request both use.                                                                                                                                                                                                                            |
| `toAggregateInstant` / `toAggregateOrdered`                                                                                                                                                                                                                                                                              | How `min` / `max` compare a value: a `Date`, a finite number, or a strict ISO date / datetime / time string. Locale forms are skipped, not guessed.                                                                                                                                                                                                                                                                                                                                                  |
