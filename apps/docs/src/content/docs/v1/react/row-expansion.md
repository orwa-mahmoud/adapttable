---
title: "React table expandable rows & detail panels (v1)"
...
head:
  ...
  - tag: script
    ...
    content: '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"AdaptTable","item":"https://adapttable.orwamahmoud.com/"},{"@type":"ListItem","position":2,"name":"React
      ...
      panels","item":"https://adapttable.orwamahmoud.com/v1/react/row-expansion/"}]}'
  - tag: meta
    attrs:
      property: og:image
      content: https://adapttable.orwamahmoud.com/og/row-expansion.png
  - tag: meta
    attrs:
      name: twitter:image
      content: https://adapttable.orwamahmoud.com/og/row-expansion.png
slug: v1/react/row-expansion
---
...
| `rowKey`          | `(row: TRow) => string`    | —       | Already required; expansion state is keyed by this id (or by `selectionGetId` when set). |
