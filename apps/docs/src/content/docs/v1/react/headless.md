...
head:
  ...
  - tag: script
    ...
    content: '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"AdaptTable","item":"https://adapttable.orwamahmoud.com/"},{"@type":"ListItem","position":2,"name":"Headless
      React table — useDataTable
      getters","item":"https://adapttable.orwamahmoud.com/v1/react/headless/"}]}'
  - tag: meta
    attrs:
      property: og:image
      content: https://adapttable.orwamahmoud.com/og/headless.png
  - tag: meta
    attrs:
      name: twitter:image
      content: https://adapttable.orwamahmoud.com/og/headless.png
slug: v1/react/headless
---
...
* **The source owns the data and the state.** `useFrontendData` filters,
  ...
  instead). See [data tiers](/v1/data-tiers/).
...
Related: [concepts](/v1/concepts/) · [data tiers](/v1/data-tiers/) ·
[customization](/v1/react/customization/) · [sorting](/v1/react/sorting/) ·
[pagination](/v1/react/pagination/) · [selection](/v1/react/selection/) ·
[URL state](/v1/react/url-state/) · [API reference](/v1/react/api/)
