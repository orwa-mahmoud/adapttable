...
head:
  ...
  - tag: script
    ...
    content: '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"AdaptTable","item":"https://adapttable.orwamahmoud.com/"},{"@type":"ListItem","position":2,"name":"Realtime
      React data table — live row
      updates","item":"https://adapttable.orwamahmoud.com/v2/react/realtime/"}]}'
  - tag: meta
    attrs:
      property: og:image
      content: https://adapttable.orwamahmoud.com/og/realtime.png
  - tag: meta
    attrs:
      name: twitter:image
      content: https://adapttable.orwamahmoud.com/og/realtime.png
slug: v2/react/realtime
---
...
**Related:** [Inline cell editing](/v2/react/cell-editing/) · [API](/v2/react/api/) ·
...
this page. That lives under [cell editing](/v2/react/cell-editing/#live-update-conflicts).
...
* [API reference](/v2/react/api/) lists `applyRowPatches`, `applyRowPatchesWithLog`
