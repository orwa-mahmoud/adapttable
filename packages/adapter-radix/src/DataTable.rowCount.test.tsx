 ...
 * Core decides; this proves the radix table element carries it — Radix Themes' Table.Root spreads props onto its scroll wrapper.
 */
...
describe("windowed table — dataset size (radix)", () => {
