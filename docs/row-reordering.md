...
▶ **Try grouped and tree moves:** in the [Feature Lab](https://orwa-mahmoud.github.io/adapttable/demo/all-options/), choose Grouped or Tree, then turn Reorder on. Switch adapters without losing the scenario.
